...
public final class C_OpCode {
  ...
  public static final byte OP_GET_ELEMENT   = 0x0C; //simple
  ...
  public static final byte OP_METHOD        = 0x19; //const (method name)
  public static final byte OP_MULTIPLY      = 0x1A; //simple
  public static final byte OP_NEGATE        = 0x1B; //simple
  public static final byte OP_NIL           = 0x1C; //simple
  public static final byte OP_NOT           = 0x1D; //simple
  public static final byte OP_OBJECT        = 0x1E; //const (object name)
  public static final byte OP_POP           = 0x1F; //simple
  public static final byte OP_RETURN        = 0x20; //simple
  public static final byte OP_SET_GLOBAL    = 0x21; //const (global name)
  public static final byte OP_SET_LOCAL     = 0x22; //operand (stack offset)
  public static final byte OP_SET_PROP      = 0x23; //const (prop name)
  public static final byte OP_SET_UPVAL     = 0x24; //operand
  public static final byte OP_SUBTRACT      = 0x25; //simple
  public static final byte OP_SUPER_INVOKE  = 0x26; //invoke
  public static final byte OP_TRUE          = 0x27; //simple
