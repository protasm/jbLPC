...
import static jbLPC.preprocessor.PreprocessorCommand.PP_ERROR;
import static jbLPC.preprocessor.Token.AND_EQ;
import static jbLPC.preprocessor.Token.ARROW;
import static jbLPC.preprocessor.Token.CCOMMENT;
import static jbLPC.preprocessor.Token.CHARACTER;
import static jbLPC.preprocessor.Token.CPPCOMMENT;
import static jbLPC.preprocessor.Token.DEC;
import static jbLPC.preprocessor.Token.DIV_EQ;
import static jbLPC.preprocessor.Token.ELLIPSIS;
import static jbLPC.preprocessor.Token.EOF;
import static jbLPC.preprocessor.Token.EQ;
import static jbLPC.preprocessor.Token.GE;
import static jbLPC.preprocessor.Token.HASH;
import static jbLPC.preprocessor.Token.HEADER;
import static jbLPC.preprocessor.Token.IDENTIFIER;
import static jbLPC.preprocessor.Token.INC;
import static jbLPC.preprocessor.Token.INVALID;
import static jbLPC.preprocessor.Token.LAND;
import static jbLPC.preprocessor.Token.LE;
import static jbLPC.preprocessor.Token.LOR;
import static jbLPC.preprocessor.Token.LSH;
import static jbLPC.preprocessor.Token.LSH_EQ;
import static jbLPC.preprocessor.Token.MOD_EQ;
import static jbLPC.preprocessor.Token.MULT_EQ;
import static jbLPC.preprocessor.Token.M_ARG;
import static jbLPC.preprocessor.Token.M_PASTE;
import static jbLPC.preprocessor.Token.M_STRING;
import static jbLPC.preprocessor.Token.NE;
import static jbLPC.preprocessor.Token.NL;
import static jbLPC.preprocessor.Token.NUMBER;
import static jbLPC.preprocessor.Token.OR_EQ;
import static jbLPC.preprocessor.Token.PASTE;
import static jbLPC.preprocessor.Token.PLUS_EQ;
import static jbLPC.preprocessor.Token.P_LINE;
import static jbLPC.preprocessor.Token.RANGE;
import static jbLPC.preprocessor.Token.RSH;
import static jbLPC.preprocessor.Token.RSH_EQ;
import static jbLPC.preprocessor.Token.SQSTRING;
import static jbLPC.preprocessor.Token.STRING;
import static jbLPC.preprocessor.Token.SUB_EQ;
import static jbLPC.preprocessor.Token.WHITESPACE;
import static jbLPC.preprocessor.Token.XOR_EQ;
...
import jbLPC.preprocessor.PreprocessorListener.SourceChangeEvent;
import jbLPC.preprocessor.fs.JavaFileSystem;
import jbLPC.preprocessor.fs.VirtualFile;
import jbLPC.preprocessor.fs.VirtualFileSystem;
import jbLPC.preprocessor.source.FileLexerSource;
import jbLPC.preprocessor.source.FixedTokenSource;
import jbLPC.preprocessor.source.LexerSource;
import jbLPC.preprocessor.source.MacroTokenSource;
...
public class Preprocessor implements Closeable {
  ...
  public String preprocess() {
    ...
    setListener(new DefaultPreprocessorListener());
    getWarnings().clear();
